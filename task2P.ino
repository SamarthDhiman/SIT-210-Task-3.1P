...
char ssid[] = "jio_4g";        // your network SSID (name)
char pass[] = "23jan2010";    // your network password (use for WPA, or use as key for WEP)
...
String APIKey = "R89B7YK9QQHPT5S2";             // enter your channel's Write API Key
